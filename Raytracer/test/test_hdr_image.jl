@testset "HDR Image" begin
    ...
    @testset "IO" begin
        ...
        _c5 = RGB(400., 500., 600.)
        _c6 = RGB(700., 800., 900.)
        rgb_pixel_matrix = [_c1 _c4
                             _c2 _c5
                             _c3 _c6]
        image = HdrImage{RGB{Float32}}(rgb_pixel_matrix)
        expected_output_le = Array{UInt8}([0x50, 0x46, 0x0a, 0x33, 0x20, 0x32, 0x0a, 0x2d, 0x31, 0x2e, 0x30, 0x0a,
        ...
        expected_output_be = Array{UInt8}([0x50, 0x46, 0x0a, 0x33, 0x20, 0x32, 0x0a, 0x31, 0x2e, 0x30, 0x0a, 0x42,
        ...
        write(io, image)
        if (little_endian)
            @test take!(io) == expected_output_le
        else
            @test take!(io) == expected_output_be
        end
    end
