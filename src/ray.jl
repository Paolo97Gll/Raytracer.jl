...
struct Ray{T<:AbstractFloat}
    ...
    function Ray(origin::Point, dir::Vec, tmin::T, tmax::T, depth::Int) where {T}
...
"""
Ray{T}(origin::Point, dir::Vec; tmin::T = 1e-5, tmax::T = typemax(T), depth::Int = 0) where {T <: AbstractFloat} = Ray(origin, dir, tmin, tmax, depth)
